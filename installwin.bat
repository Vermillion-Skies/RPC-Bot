...
cd ..
cd ..
curl "https://raw.githubusercontent.com/Vermillion-Skies/RPC-Bot/main/updater.bat" -o "updater.bat"
curl "https://raw.githubusercontent.com/Vermillion-Skies/RPC-Bot/main/startbot.bat" -o "startbot.bat"
cd assets/
